...
### 1. Reporting Bugs
If you encounter a bug while using Termo-Kali, please report it by [creating an issue](https://github.com/Kaztral-ar/Termkali/issues/new). Include the following details:
...
Have an idea for a new feature or improvement? Open a feature request by [creating an issue](https://github.com/Kaztral-ar/Termkali/issues/new). Include:
...
2. **Clone Your Fork**:
   ```bash
   git clone https://github.com/Kaztral-ar/Termkali.git
   cd termo-kali
   ```
3. **Create a Branch**:
   ```bash
